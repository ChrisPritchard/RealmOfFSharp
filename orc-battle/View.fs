...
let getView runState battle = 
    ...
    let text = 
        seq {
            match battle.state with
            | OrcTurn _ -> 
                yield { assetKey = "default"; text = "The Orcs Are Attacking!"; position = 80,350; origin = TopLeft; scale = 0.5 }
            | GameOver ->
                yield { assetKey = "default"; text = "Game Over!"; position = 200,350; origin = TopLeft; scale = 1.0 }
                yield { assetKey = "default"; text = "Press R to restart or ESC to exit"; position = 200,410; origin = TopLeft; scale = 0.3 }
            | Victory ->
                yield { assetKey = "default"; text = "Victory!"; position = 200,350; origin = TopLeft; scale = 1.0 }
                yield { assetKey = "default"; text = "Press R to restart or ESC to exit"; position = 200,410; origin = TopLeft; scale = 0.3 }
            | PlayerTurn state ->
                yield { assetKey = "default"; text = "Player Turn"; position = 80,200; origin = TopLeft; scale = 0.5 }
                let actionsStatus = sprintf "Actions Remaining: %i" state.actionsRemaining
                yield { assetKey = "default"; text = actionsStatus; position = 80,240; origin = TopLeft; scale = 0.3 }
                if state.actionsRemaining = 0 then
                    yield { assetKey = "default"; text = "Press ENTER to"; position = 80,260; origin = TopLeft; scale = 0.3 } 
                    yield { assetKey = "default"; text = " end turn"; position = 80,280; origin = TopLeft; scale = 0.3 } 
                else
                    yield { assetKey = "default"; text = "Press S to stab,"; origin = TopLeft; position = 80,260; scale = 0.3 }
                    yield { assetKey = "default"; text = "Press F to flail,"; origin = TopLeft; position = 80,280; scale = 0.3 }
                    yield { assetKey = "default"; text = "Press R to recover,"; origin = TopLeft; position = 80,300; scale = 0.3 }
                    yield { assetKey = "default"; text = "And Left or Right"; origin = TopLeft; position = 80,320; scale = 0.3 }
                    yield { assetKey = "default"; text = " to change target"; origin = TopLeft; position = 80,340; scale = 0.3 }
